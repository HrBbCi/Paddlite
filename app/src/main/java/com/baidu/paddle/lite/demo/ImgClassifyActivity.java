...
public class ImgClassifyActivity extends CommonActivity {
    ...
    protected void onResume() {
        ...
        int cpu_thread_num = Integer.parseInt(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ICS_CPU_THREAD_NUM_KEY),
        ...
        long[] input_shape =
                Utils.parseLongsFromString(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ICS_INPUT_SHAPE_KEY),
                        getString(R.string.ICS_INPUT_SHAPE_DEFAULT))), ",");
        float[] input_mean =
                Utils.parseFloatsFromString(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ICS_INPUT_MEAN_KEY),
                        getString(R.string.ICS_INPUT_MEAN_DEFAULT))), ",");
        float[] input_std =
                Utils.parseFloatsFromString(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ICS_INPUT_STD_KEY)
