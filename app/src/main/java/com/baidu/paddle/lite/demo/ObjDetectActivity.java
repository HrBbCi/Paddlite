...
public class ObjDetectActivity extends CommonActivity {
    ...
    protected void onResume() {
        ...
        settingsChanged = !Objects.requireNonNull(model_path).equalsIgnoreCase(modelPath);
        assert label_path != null;
        settingsChanged |= !label_path.equalsIgnoreCase(labelPath);
        settingsChanged |= !Objects.requireNonNull(image_path).equalsIgnoreCase(imagePath);
        int cpu_thread_num = Integer.parseInt(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ODS_CPU_THREAD_NUM_KEY),
        ...
        assert input_color_format != null;
        settingsChanged |= !input_color_format.equalsIgnoreCase(inputColorFormat);
        long[] input_shape =
                Utils.parseLongsFromString(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ODS_INPUT_SHAPE_KEY),
                        getString(R.string.ODS_INPUT_SHAPE_DEFAULT))), ",");
        float[] input_mean =
                Utils.parseFloatsFromString(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ODS_INPUT_MEAN_KEY),
                        getString(R.string.ODS_INPUT_MEAN_DEFAULT))), ",");
        float[] input_std =
                Utils.parseFloatsFromString(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ODS_INPUT_STD_KEY)
        ...
        float score_threshold =
                Float.parseFloat(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.ODS_SCORE_THRESHOLD_KEY),
